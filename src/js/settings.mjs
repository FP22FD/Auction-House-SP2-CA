// Deployed base path
// @ts-ignore
export const APP_GITHUB_PAGES_REPO = import.meta.env.VITE_APP_GITHUB_PAGES_REPO || "__VITE_APP_GITHUB_PAGES_REPO__"; // 'Auction-House-SP2-CA'
...
export const API_LISTINGS_PROFILE = (name) => `/auction/profiles/${name}/listings`;

export const API_BIDS_PROFILE = `/bids?_listings=true`;
export const API_BID_ON_LISTING = (listingId) => `${API_LISTINGS}/${listingId}/bids`;
